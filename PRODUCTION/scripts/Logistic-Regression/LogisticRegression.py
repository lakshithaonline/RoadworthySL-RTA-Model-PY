...
def preprocess_data(data):
    if 'Outcome' not in data.columns:
        logging.error("The 'Outcome' column is missing from the dataset.")
        raise ValueError("The 'Outcome' column is missing from the dataset.")
...
def main():
    ...
    # Save the model
    save_model(model, '../../models/logisticR.joblib')
